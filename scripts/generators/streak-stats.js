function generateStreakStatsSVG(data) {
  ...
  const formatRange = (start, end) => {
      ...
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation: isolate" viewBox="0 0 ${cardWidth} ${cardHeight}" width="${cardWidth}px" height="${cardHeight}px" direction="ltr">
            ...
            <defs>
                ...
                <clipPath id="outer_rectangle">
                    ...
                    <rect width="${cardWidth}" height="${cardHeight}" rx="4.5"/>
            ...
            <g clip-path="url(#outer_rectangle)">
                ...
                <g style="isolation: isolate">
                    ...
                    <rect stroke="${colors.border}" fill="${colors.bg}" rx="4.5" x="0.5" y="0.5" width="${cardWidth - 1}" height="${cardHeight - 1}"/>
                ...
                <g style="isolation: isolate">
                    ...
                    <g mask="url(#mask_out_ring_behind_fire)">
                        ...
                        <circle cx="247.5" cy="71" r="40" fill="none" stroke="${colors.ring}" stroke-width="5" style="opacity: 0; animation: fadein 0.5s linear forwards 0.4s"/>
