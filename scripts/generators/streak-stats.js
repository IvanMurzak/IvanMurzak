function generateStreakStatsSVG(data, options = {}) {
  ...
  <svg width="${cardWidth}" height="${cardHeight}" viewBox="0 0 ${cardWidth} ${cardHeight}" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(82.5, 114)">
        <text x="0" y="32" text-anchor="middle" class="date" style="opacity: 0; animation: fadein 0.5s linear forwards 0.8s">${formatDate(firstContributionDate)} - Present</text>
    </g>
    ...
    <g transform="translate(412.5, 114)">
         <text x="0" y="32" text-anchor="middle" class="date" style="opacity: 0; animation: fadein 0.5s linear forwards 1.4s">${formatRange(longestStreakRange.start, longestStreakRange.end)}</text>
    </g>
