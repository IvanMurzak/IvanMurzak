...
function generateCommitsMonthlySVG(theme, months) {
  ...
  <style>
    ...
    #m-nowGlow { animation: breathe 2.8s ease-in-out 2.2s infinite alternate; opacity: 0; }
    #m-ping { transform-box: fill-box; transform-origin: center; animation: ping 2.6s ease-out 2.4s infinite; opacity: 0; }
